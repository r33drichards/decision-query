...
#
# TARGET CMake target name; defaults to NAME. The module file is always named
# after NAME.
#
# TEMP_CONFIG Extra postgresql.conf file for the pg_regress temporary instance.
function(add_postgresql_extension NAME)
  set(_optional)
  set(_single VERSION ENCODING COMMENT TARGET TEMP_CONFIG)
  ...
  # extension.
  if(_ext_TARGET)
    set(_target ${_ext_TARGET})
  else()
    set(_target ${NAME})
  endif()
  add_library(${_target} MODULE ${_ext_SOURCES})
...
module_pathname = '$libdir/$<TARGET_FILE_NAME:${_target}>'
...
")
  ...
  install(TARGETS ${_target} LIBRARY DESTINATION ${PostgreSQL_PACKAGE_LIBRARY_DIR})
  ...
  if(_ext_REGRESS)
    ...
    set(_regress_options)
    if(_ext_TEMP_CONFIG)
      list(APPEND _regress_options --temp-config=${_ext_TEMP_CONFIG})
    endif()
    if(PG_REGRESS)
      add_test(
        NAME ${NAME}
        COMMAND
          ${PG_REGRESS} --temp-instance=${CMAKE_BINARY_DIR}/tmp_check ${_regress_options}
